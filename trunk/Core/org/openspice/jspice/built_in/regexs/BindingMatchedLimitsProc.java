...
public class BindingMatchedLimitsProc extends UnaryFastProc {

	{
		setDescription( "bindingMatchedLimits", "%p( B:Binding ) -> ( lo:Int, hi:Int )", "Returns start and end index (inclusive) of the match" );
	}

	public Object fastCall( Object tos, VM vm, int nargs ) {
		final Binding b = CastLib.toBinding( tos );
		final int lo = b.getStart();
		final int hi = b.getEnd();
	...
	public static final BindingMatchedLimitsProc BINDING_MATCHED_LIMITS_PROC = new BindingMatchedLimitsProc();
