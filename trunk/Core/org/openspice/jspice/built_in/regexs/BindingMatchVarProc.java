...
public class BindingMatchVarProc extends Binary1InvokeProc {

	{
		setDescription( "bindingMatchVar", "%p( B:Binding ) -> S:String", "Returns the matched string" );
	}

	public Object invoke( final Object binding, final Object index ) {
		final Binding b = CastLib.toBinding( binding );
		final int i = CastLib.to_int( index );
		return b.getMatched( i );
	}

	public static final BindingMatchVarProc BINDING_MATCH_VAR_PROC = new BindingMatchVarProc();
