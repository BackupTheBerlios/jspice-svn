...
public class NotNumEqualProc extends Binary1InvokeProc {

	public Object invoke( final Object x, final Object y ) {
		return Boolean.valueOf( !NumEqual.equal( CastLib.toNumber( x ), CastLib.toNumber(  y ) ) );
	}

	public static final NotNumEqualProc notNumEqualProc = new NotNumEqualProc();
