...
public class SplitProc extends Binary1InvokeProc {

	{
		setDescription( "split", "%p( R:RegEx, S:String ) -> {String}", "Splits a string S using R to denote the boundaries" );
	}

	public static final SplitProc SPLIT_PROC = (
		new SplitProc()
	);
