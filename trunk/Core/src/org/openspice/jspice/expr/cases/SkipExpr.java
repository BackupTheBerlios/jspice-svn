...
import org.openspice.jspice.expr.cases.NullaryExpr;
import org.openspice.jspice.expr.Expr;
import org.openspice.jspice.expr.ExprVisitor;
import org.openspice.jspice.expr.iterators.ExprIterator;
import org.openspice.jspice.datatypes.Arity;

public final class SkipExpr extends NullaryExpr implements ZeroResults {
	public Arity arity() {
		return this.defaultArity();
	}

	public static SkipExpr SKIP_EXPR = new SkipExpr();
	...
	public Object visit( final ExprVisitor visitor, final Object arg ) {
		return visitor.visitSkipExpr( this, arg );
	}
